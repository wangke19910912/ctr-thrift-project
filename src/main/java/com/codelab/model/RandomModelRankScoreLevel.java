 ...
 */
public class RandomModelRankScoreLevel extends Model {
    private static final Logger LOGGER = LoggerFactory.getLogger(RandomModelRankScoreLevel.class);
    ...
    public Double score(Set<String> featureValues, String expId, AdData adData, HistoricalDataCorpus historicalDataCorpus, ContextData contextData, String lookBackWindow, Boolean media) {
        if (adData.isSetBidPrice() && adData.getBidPrice() != 0.0) {
            return generateDefaultScore() / adData.getBidPrice();
        }
